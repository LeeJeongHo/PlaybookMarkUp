StartTest(function (t) {
    ...
    var ignoreRe = /Ext.dd|DragZone.destroy|DragDrop.destroy|DragSource.destroy|Ext.grid.plugin.Editing.init|afterRender|initComponent|Ext.Base.configClass|Ext.Base.destroy|Ext.data.AbstractStore.getCount/;
    ...
    var MAX_NBR_OVERRIDES = Ext.isIE ? 20 : 18;
    var nbrFound = 0;
