StartTest(function(t) {
    ...
    t.is(task1.getSchedulingMode(), 'EffortDriven', 'Schedulin mode has been changed successfully')
    
    t.is(task1.getDuration(), 0, 'Duration is now 0 - no resources assigned to task')
    t.isStartEnd(task1, new Date(2011, 6, 1, 8), new Date(2011, 6, 1, 8), 'Correct start/end dates')
