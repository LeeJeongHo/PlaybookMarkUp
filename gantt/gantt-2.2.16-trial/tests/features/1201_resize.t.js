    ...
    t.chain(
        ...
        function (next) {
            var taskEl          = t.getFirstTaskBarEl(g),
                resizeHandle    = taskEl.down('.sch-resizable-handle-east');
        ...
        function (next) {
            ...
            var resizeHandle = t.getFirstTaskBarEl(g).down('.sch-resizable-handle-west');
        ...
        function (next) {
            ...
            var resizeHandle = t.getFirstTaskBarEl(g).down('.sch-resizable-handle-east');
        ...
        function (next) {
            ...
            t.drag(taskBar.down('.sch-resizable-handle-west'), null, [-20, 0], function() {

                t.is(t.getFirstTaskBarEl(g).getX(), originalX, 'Left coordinate of task bar stayed the same');

                t.drag(t.getFirstTaskBarEl(g).down('.sch-resizable-handle-east'), null, [20, 0], function() {
