StartTest(function (t) {
    ...
    function doTest (t, threshold) {
        ...
        if (threshold) {
            ...
            t.willFireNTimes(gantt.lockedGrid.view, 'itemupdate', 1, "only source row should repaint");
            t.willFireNTimes(gantt.normalGrid.view, 'itemupdate', 1, "only source row should repaint");
