StartTest(function(t) {
    ...
    t.chain(
        ...
        function (next) {
            ...
            t.is(el.dom.scrollTop, bottomScroll, 'Scroll top position of the scheduling view hasnt change')
        ...
        function (next) {
            ...
            t.is(el.dom.scrollTop, bottomScroll, 'Vertical scroll position has not been restored')
