StartTest(function (t) {
    ...
    t.chain(
        ...
        { action : 'drag', target : '.sch-resizable-handle-east', by : [7*gantt.timeAxisViewModel.getTickWidth(), 0]},
        ...
        { action : 'drag', target : '.sch-resizable-handle-west', by : [-5*gantt.timeAxisViewModel.getTickWidth(), 0]},
        ...
        { action : 'drag', target : '.sch-resizable-handle-east', by : [gantt.timeAxisViewModel.getTickWidth(), 0]},
        ...
        function (next) {
            ...
            valid = false;
            t.dragBy('.sch-resizable-handle-east', [50, 0], function () {
