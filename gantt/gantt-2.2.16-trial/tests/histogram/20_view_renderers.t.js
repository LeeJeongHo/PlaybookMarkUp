StartTest(function(t) {
    ...
    var scaleLines  = [
        ...
        bars        = [
            { id : "r1-0", height : 15, top : 33 },
            { id : "r1-1", height : 15, top : 33 }
        ];

    // since ExtJS 4.2.1 cellTopBorderWidth is zero and we need to adjust control values
    ...
    t.waitForEvent(view, "viewready", function () {
        ...
        t.it("Calculates limit line position correctly", function (t) {
            ...
            t.is(lines.length, 4, "4 lines");

            for (var i = 0, l = limitLines.length; i < l; i++) {
                t.is(lines[i].bottom, limitLines[i].bottom, i + ": correct bottom coordinate");
